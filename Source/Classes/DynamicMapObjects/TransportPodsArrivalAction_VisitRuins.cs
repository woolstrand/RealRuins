...
public class TransportPodsArrivalAction_VisitRuins : TransportPodsArrivalAction
{
	...
	public override void Arrived(List<ActiveDropPodInfo> pods, int tile)
	{
		...
		if (flag)
		{
			...
			Find.LetterStack.ReceiveLetter("LetterLabelTransportPodsArrivedAtRuins".Translate(), "LetterTransportPodsArrivedAtRuins".Translate().CapitalizeFirst(), LetterDefOf.ThreatBig, lookTarget);
		}
		else
		{
